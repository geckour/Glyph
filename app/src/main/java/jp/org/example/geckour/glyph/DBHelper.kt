...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DBHelper.DB_NAME, null, DBHelper.DB_VERSION) {
    ...
    private val SETS = arrayOf(
        ...
        arrayOf("5", "ATTACK,PURE,FUTURE,NOT,ATTACK", ",,,INSIDE,WAR"),
        arrayOf("5", "ATTACK,SEPARATE,PATH,END,JOURNEY", null),
        arrayOf("5", "AVOID,CHAOS,AVOID,SHAPERS,LIE", null),
        arrayOf("5", "AVOID,CHAOS,RECHARGE,POTENTIAL,ATTACK", ",,REPAIR,,WAR"),
        arrayOf("5", "AVOID,PERFECTION,STABILITY,HUMAN,SELF", ",,STAY,,"),
        arrayOf("5", "BREATHE,NOT,XM,LOSE,SELF", ",INSIDE,,,"),
        ...
        arrayOf("5", "CREATE,PURE,FUTURE,NOT,ATTACK", ",,,,WAR"),
        ...
        arrayOf("5", "DESTROY,CIVILIZATION,END,CONFLICT,ATTACK", ",,,,WAR"),
        arrayOf("5", "DESTROY,CIVILIZATION,PRESENT,CONFLICT,ATTACK", ",,NOW,,WAR"),
        arrayOf("5", "DESTROY,LIE,NOT,GAIN,SOUL", ",,INSIDE,,"),
        arrayOf("5", "DISTANCE,I,AVOID,HUMAN,LIE", ",SELF,,,"),
        arrayOf("5", "EASY,PAST,FUTURE,FOLLOW,SHAPERS", null),
        arrayOf("5", "ESCAPE,BODY,JOURNEY,DISTANCE,PRESENT", ",,,OUTSIDE,NOW"),
        arrayOf("5", "FORGET,ATTACK,SEE,DISTANCE,HARMONY", ",WAR,,,"),
        arrayOf("5", "FORGET,ATTACK,GAIN,DISTANCE,HARMONY", ",WAR,,,"),
        arrayOf("5", "FORGET,PAST,SEE,PRESENT,DANGER", null),
        arrayOf("5", "FORGET,ATTACK,SEE,DISTANCE,HARMONY", ",WAR,,,"),
        arrayOf("5", "GAIN,TRUTH,OPEN,HUMAN,SOUL", null),
        arrayOf("5", "HARM,EVOLUTION,PURSUE,MORE,ATTACK", ",PROGRESS,,,WAR"),
        ...
        arrayOf("5", "OLD,NATURE,LESS,STRONG,PRESENT", ",,,,NOW"),
        arrayOf("5", "DISTANCE,SELF,AVOID,HUMAN,LIE", "OUTSIDE,,,,"),
        ...
        arrayOf("5", "PURSUE,CONFLICT,ADVANCE,ATTACK,CHAOS", ",,,WAR,"),
        arrayOf("5", "PURSUE,CONFLICT,ATTACK,ADVANCE,CHAOS", ",,WAR,,"),
        arrayOf("5", "PURSUE,PATH,DISTANCE,SHAPERS,LIE", ",,OUTSIDE,,"),
        ...
        arrayOf("5", "REBEL,IDEA,EVOLUTION,DESTINY,PRESENT", ",,,,NOW"),
        arrayOf("5", "RECHARGE,NOT,RECHARGE,HUMAN,SOUL", "REPAIR,INSIDE,REPAIR,,"),
        arrayOf("5", "RECHARGE,PRESENT,RECHARGE,HUMAN,SOUL", "REPAIR,,REPAIR,,"),
        arrayOf("5", "RECHARGE,SOUL,LESS,HUMAN,HARM", "REPAIR,,,,"),
        ...
        arrayOf("5", "SIMPLE,OLD,TRUTH,JOURNEY,NOT", ",,,,INSIDE"),
        arrayOf("5", "SIMPLE,TRUTH,FORGET,EASY,EVOLUTION", ",,,,SUCCESS"),
        arrayOf("5", "SIMPLE,TRUTH,SHAPERS,DESTROY,CIVILIZATION", null),
        arrayOf("5", "STABILITY,STRONG,TOGETHER,DEFEND,RESISTANCE", "STAY,,,,"),
        ...
        arrayOf("4", "ADVANCE,FUTURE,NOT,ATTACK", ",,,WAR"),
        arrayOf("4", "ADVANCE,CIVILIZATION,AGAIN,FAILURE", ",,REPEAT,"),
        arrayOf("4", "ALL,CHAOS,NOT,BODY", ",,INSIDE,"),
        arrayOf("4", "ATTACK,CIVILIZATION,AGAIN,FAILURE", ",,REPEAT,"),
        ...
        arrayOf("4", "FORGET,CONFLICT,OPEN,ATTACK", ",,ACCEPT,WAR"),
        ...
        arrayOf("4", "HIDE,IMPURE,HUMAN,IDEA", ",,,THOUGHT"),
        ...
        arrayOf("4", "IMPROVE,MIND,BODY,NOT", ",,,INSIDE"),
        arrayOf("4", "IMPROVE,MIND,JOURNEY,NOT", ",,,INSIDE"),
        arrayOf("4", "NOT,MIND,JOURNEY,PERFECTION", "INSIDE,,,"),
        arrayOf("4", "NOT,MIND,SOUL,HARMONY", "INSIDE,,,"),
        arrayOf("4", "JOURNEY,NOT,IMPROVE,SOUL", ",INSIDE,,"),
        ...
        arrayOf("4", "BREATHE,AGAIN,JOURNEY,AGAIN", "LIVE,,,"),
        arrayOf("4", "BREATHE,NATURE,PERFECTION,HARMONY", "LIVE,,BALANCE,"),
        arrayOf("4", "LOSE,DANGER,GAIN,SAFETY", null),
        arrayOf("4", "MORE,MIND,LESS,SOUL", ",,,SPIRIT"),
        arrayOf("4", "NOT,MIND,JOURNEY,PERFECTION", null),
        arrayOf("4", "NOURISH,XM,CREATE,IDEA", ",,,THOUGHT"),
        arrayOf("4", "OPEN,CHAOS,NOT,BODY", ",,INSIDE,"),
        ...
        arrayOf("4", "HARMONY,PATH,NOURISH,FUTURE", "PEACE,,,"),
        arrayOf("4", "HARMONY,PATH,NOURISH,PRESENT", "PEACE,,,NOW"),
        arrayOf("4", "PERFECTION,PERFECTION,SAFETY,ALL", ",BALANCE,,"),
        ...
        arrayOf("4", "SHAPERS,AVOID,PURE,IDEA", ",,,THOUGHT"),
        ...
        arrayOf("4", "SIMPLE,TRUTH,BREATHE,NATURE", ",,LIVE,"),
        arrayOf("4", "SOUL,HUMAN,REBEL,DIE", null),
        arrayOf("4", "STABILITY,PURE,BREATHE,KNOWLEDGE", ",,LIVE,"),
        arrayOf("4", "STABILITY,TOGETHER,DEFEND,TRUTH", "STAY,,,"),
        arrayOf("4", "STRONG,IDEA,PURSUE,TRUTH", null),
        arrayOf("4", "STRONG,RESISTANCE,CAPTURE,PORTAL", null),
        arrayOf("4", "STRONG,TOGETHER,AVOID,ATTACK", ",,,WAR"),
        ...
        arrayOf("3", "AGAIN,JOURNEY,DISTANCE", ",,OUTSIDE"),
        ...
        arrayOf("3", "AVOID,ATTACK,CHAOS", ",WAR,"),
        arrayOf("3", "ANSWER,AGAIN,AVOID", ",REPEAT,"),
        arrayOf("3", "CAPTURE,SHAPERS,PORTAL", null),
        arrayOf("3", "CAPTURE,XM,PORTAL", null),
        arrayOf("3", "CHANGE,HUMAN,FUTURE", null),
        arrayOf("3", "CIVILIZATION,ATTACK,CHAOS", ",WAR,"),
        arrayOf("3", "COMPLEX,JOURNEY,FUTURE", null),
        arrayOf("3", "CONTEMPLATE,JOURNEY,DISTANCE", ",,OUTSIDE"),
        ...
        arrayOf("3", "GAIN,CIVILIZATION,HARMONY", ",,PEACE"),
        ...
        arrayOf("3", "NOT,MIND,FUTURE", "INSIDE,,"),
        arrayOf("3", "NOT,XM,TRUTH", "INSIDE,,"),
        arrayOf("3", "JOURNEY,NOT,SOUL", ",INSIDE,"),
        ...
        arrayOf("3", "LOSE,ATTACK,RETREAT", ",WAR,"),
        arrayOf("3", "MIND,BODY,BREATHE", ",,LIVE"),
        arrayOf("3", "MIND,EQUAL,TRUTH", null),
        arrayOf("3", "MIND,OPEN,BREATHE", ",,LIVE"),
        ...
        arrayOf("3", "OPEN ALL,PORTAL,EVOLUTION", ",,SUCCESS"),
        arrayOf("3", "OPEN ALL,SIMPLE,TRUTH", null),
        arrayOf("3", "PAST,EQUAL,FUTURE", null),
        arrayOf("3", "PAST,HARMONY,DIFFICULT", null),
        arrayOf("3", "PAST,HARMONY,DIFFICULT", ",PEACE,"),
        arrayOf("3", "PAST,PRESENT,FUTURE", null),
        arrayOf("3", "PATH,HARMONY,DIFFICULT", ",PEACE,"),
        arrayOf("3", "HARMONY,SIMPLE,JOURNEY", "PEACE,,"),
        arrayOf("3", "HARMONY,STABILITY,FUTURE", "PEACE,,"),
        arrayOf("3", "PERFECTION,PAST,HARMONY", ",,PEACE"),
        arrayOf("3", "POTENTIAL,TRUTH,HARMONY", null),
        arrayOf("3", "POTENTIAL,XM,ATTACK", null),
        arrayOf("3", "POTENTIAL,XM,HARMONY", ",,PEACE"),
        ...
        arrayOf("3", "RECHARGE,NATURE,PERFECTION", "REPAIR,,BALANCE"),
        arrayOf("3", "AGAIN,JOURNEY,DISTANCE", "REPEAT,,OUTSIDE"),
        arrayOf("3", "AGAIN,SEARCH,SAFETY", "REPEAT,,"),
        arrayOf("3", "SEARCH,XM,PORTAL", null),
        arrayOf("3", "SEE,TRUTH,PRESENT", ",,NOW"),
        ...
        arrayOf("3", "WANT,TRUTH,PRESENT", ",,NOW"),
        arrayOf("3", "ATTACK,ATTACK,CHAOS", "WAR,,"),
        arrayOf("3", "ATTACK,CREATE,DANGER", "WAR,,"),
        arrayOf("3", "ATTACK,DESTROY,FUTURE", "WAR,,"),
        ...
        arrayOf("2", "PATH,HARMONY", ",PEACE"),
        arrayOf("2", "PATH,PERFECTION", null),
        arrayOf("2", "HARMONY,STABILITY", "PEACE,"),
